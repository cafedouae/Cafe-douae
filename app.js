...
/* ================================================================
   NAVIGATION
================================================================ */
const VIEW_TITLES={caisse:"Caisse",tickets:"Tickets",stock:"Stock",produits:"Menu & Produits",serveurs:"Serveurs",stats:"Statistiques",rapport:"Rapport des ventes"};
...
async function loadDashboard(){
  ...
  document.getElementById("kpi-total").textContent=dh(totalRev);
  document.getElementById("kpi-matin").textContent=dh(matin.reduce((s,t)=>s+Number(t.total),0));
  document.getElementById("kpi-soir").textContent=dh(soir.reduce((s,t)=>s+Number(t.total),0));
  ...
  document.getElementById("stats-sections").innerHTML=Object.entries(bySec).map(([name,val])=>{
